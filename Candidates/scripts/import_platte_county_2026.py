# Candidates/scripts/import_platte_county_2026.py
#!/usr/bin/env python3
"""Generate INSERT SQL for Platte County 2026 race and candidate data.

Usage:
    python3 Candidates/scripts/import_platte_county_2026.py > /tmp/platte_county_insert.sql

Requires: Candidates/db/migrations/0004_offices_expand.sql applied first.
Source CSVs: /tmp/platte_county_2026/
"""
import csv
import hashlib
import re
...
CSV_DIR = "/tmp/platte_county_2026"
...
def main():
    race_rows = load_csv(f"{CSV_DIR}/platte_county_2026_races.csv", RACE_HEADERS)
    candidate_rows = load_csv(f"{CSV_DIR}/platte_county_2026_candidates.csv", CANDIDATE_HEADERS)
